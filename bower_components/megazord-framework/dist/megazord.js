        ...
        this.$get = ['$state', '$injector', '$ionicHistory', '$rootScope', 'lodash', function($state, $injector, $ionicHistory, $rootScope, _){
           ...
           return {
               ...
               fireEvent: function(event) {
                   ...
                   var parent = parents[currentStateName];
                   if(parent) {
                       currentStateName = currentStateName.substring(parent.length + 1);
                   }
                ...
                * @methodOf megazord._router
                * @description
                * Forces transition to a given state, ignoring the routing table.
                *
               ...
               goToState: function(state, event) {
                   ...
                   var dataSourceParams = _.merge({}, dataSourceSettings.params);
